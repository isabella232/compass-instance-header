# instance-header [![][travis_img]][travis_url]

> The plugin for the instance header
...
[travis_img]: https://travis-ci.org/mongodb-js/compass-instance-header.svg?branch=master
[travis_url]: https://travis-ci.org/mongodb-js/compass-instance-header
